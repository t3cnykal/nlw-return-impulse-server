...
const nodemailer_amil_adapter_1 = require("./adapters/nodemailer/nodemailer-amil-adapter");
...
exports.routes.post('/feedbacks', async (req, res) => {
    ...
    const nodemailerMailAdapter = new nodemailer_amil_adapter_1.NodemailerMailAdapter();
